	...
	<div class=row>
		<div class="container mgn-top">
			...
			<div class="col-lg-4 animated fadeInUp">
			 <h5 class="text-center" style="color:white;">${error}</h5>
	      <h3 class="text-danger text-center">  Forgot Password  </h3><br>
				...
				<div style="background-color: #FFF;" class=well>
					<form action=forgotProcess method=post class=role>
						...
						<br>
						<button type=submit class="btn btn-primary btn-block" name="sendMail" value="sendMail">Mail
							send</button>
					</form>
					<a href=loginPage>

...
<%
	...
	if(apas=="" || fname=="" || lname=="" || mno=="" || mid=="" || pinc=="" || address=="" || city=="" || district=="")
	{
	...
	if(flag==1 && flag1==0 && flag2==0 && flag3==0 && flag4==0)
	{
		...
		try
		{
			updadmin.setString(1,apas);
			updadmin.setString(2,fname);
			updadmin.setString(3,lname);
			updadmin.setString(4,gender);
			updadmin.setString(5,mno);
			updadmin.setString(6,mid);
			updadmin.setString(7,address);
			updadmin.setString(8,pinc);
			updadmin.setString(9,city);
			updadmin.setString(10,district);
			updadmin.setString(11,state);
			updadmin.setString(12,aid);
			updadmin.executeUpdate();
			  ...
			  <div class="row">
			   <div class="container">
				...
				<input type="hidden" name="apas" value="<%=request.getParameter("apas") %>"></input>
			      <button class="btn  btn-danger"><i class="glyphicon glyphicon-home"></i>&nbsp;LogIn-Again</button></form>
			    </div>
			   </div>
			  </div>

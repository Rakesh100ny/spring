      ...
      <div class="col-lg-6 text-center form-group">
       <table class="table">
        ...
        <tr>
         ...
         <td><input type="number" class="form-control" name="tid" readonly="true" value=1001></td>
        </tr>              
        <tr>
      ...
      <div class="col-lg-6 text-center form-group">
       <table class="table">
        <tr>
         ...
         <button class="btn btn-block btn-primary mgnbtm">Create New Account</button>

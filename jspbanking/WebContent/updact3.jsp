...
<%
	...
	if(flag==1 && flag1==0 && flag2==0 && flag3==0 && flag4==0)
	{
			...
			%>
			  <div class="row">
			   <div class="container">
				...
				<input type="hidden" name="pas" value="<%=request.getParameter("pas") %>"></input>
		...
		{	
			System.err.println("\nSQL Alert[updact3.jsp]..."+e.getMessage()+"\n");
		}
					...
					<div class="row">
						<div class="container">
							<div class="col-lg-12 ">
								...
								<h2 class="text-danger text-center">[ <%=msg %> ]</font></h2>					
							</div>
						</div>
					</div>
				    <div class="row">
			      ...
			      <div class="col-lg-6  animated fadeInRight text-center form-group">
			       <table class="table">
			        <tr>
			         ...
			         <td><input type="text" class="form-control" readonly="true" name="obal" value=<%=obal1%>></td>
			        </tr>       
			      </table>
